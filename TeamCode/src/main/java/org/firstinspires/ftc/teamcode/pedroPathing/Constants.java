...
public class Constants {
    public static FollowerConstants followerConstants = new FollowerConstants()
            .mass(4.5)
            .forwardZeroPowerAcceleration(-54.69241155732213)
            .lateralZeroPowerAcceleration(-68.28658718583979)
    ...
    public static PathConstraints pathConstraints = new PathConstraints(0.99, 100, 0.65, 0.25);
    public static MecanumConstants driveConstants = new MecanumConstants()
            ...
            .xVelocity(70.25118994525099)
            .yVelocity(61.70463453878568);

    public static PinpointConstants localizerConstants = new PinpointConstants()
            .forwardPodY(0.486496063)
            .strafePodX(-2.42055118)
