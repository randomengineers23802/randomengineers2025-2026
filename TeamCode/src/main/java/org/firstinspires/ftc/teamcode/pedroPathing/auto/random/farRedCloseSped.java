...
@Autonomous(name = "farRedCloseSped", group = "Autonomous")
@Configurable
@Disabled
public class farRedCloseSped extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Path1 = follower
                    .pathBuilder()
                    .addPath(new BezierLine(new Pose(87.125, 8.5625), new Pose(84.000, 95.000)))
                    .setLinearHeadingInterpolation(Math.toRadians(90), Math.toRadians(222))
                    .build();

            Path2 = follower
                    .pathBuilder()
                    .addPath(new BezierLine(new Pose(72.000, 81.000), new Pose(132.000, 84.000)))
                    .setTangentHeadingInterpolation()
                    .build();

            Path3 = follower
                    .pathBuilder()
                    .addPath(new BezierLine(new Pose(132.000, 84.000), new Pose(84.000, 95.000)))
                    .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(222))
                    .build();

            Path4 = follower
                    .pathBuilder()
                    .addPath(new BezierCurve(new Pose(72.000, 81.000), new Pose(67.000, 59.000), new Pose(135.000, 59.000)))
                    .setTangentHeadingInterpolation()
                    .build();

            Path5 = follower
                    .pathBuilder()
                    .addPath(new BezierLine(new Pose(135.000, 59.000), new Pose(84.000, 95.000)))
                    .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(222))
                    .build();

            Path6 = follower
                    .pathBuilder()
                    .addPath(new BezierLine(new Pose(72.000, 81.000), new Pose(105.000, 15.000)))
                    .setLinearHeadingInterpolation(Math.toRadians(222), Math.toRadians(270))
                    .build();
        }
    }
