...
public class FinalTeleOpBlueButNotBuns extends OpMode {
    ...
    public void init() {
        ...
        farShoot = () -> follower.pathBuilder()
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(60, 13))))
                .setHeadingInterpolation(HeadingInterpolator.linearFromPoint(follower::getHeading, Math.toRadians(291.5), 0.8))
                .build();
        ...
        closeShoot = () -> follower.pathBuilder()
                ...
                .setHeadingInterpolation(HeadingInterpolator.linearFromPoint(follower::getHeading, Math.toRadians(304), 0.8))
                .build();
    }
    ...
    public void loop() {
        ...
        // Continuous auto-aim while left trigger is held
        ...
        if (downPressed && !downPreviouslyPressed) {
            follower.setPose(new Pose(72, 81, Math.toRadians(304)));
            follower.update();
        }
